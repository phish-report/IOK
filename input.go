...
type Input struct {
	...
	requestHostname []string   // Hostnames of requests made by the page (and assets loaded by the page)
	RequestIP       []string   // IPs contacted as part of requests made by the page
	requestASN      []int      // ASNs contacted as part of requests made by the page
